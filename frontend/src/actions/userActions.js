...
export const campaignLive =(id) => async (dispatch,getState)=>{

    try{
    dispatch({
        type:LIVE_GET_REQUEST
    })

        //console.log("hahahaa",va)
    const {data} =await axios.get(`/api/users/indiegogo/daily/${id}/`)
    console.log("Dekh lo:   ",data)
    dispatch({
              type:LIVE_GET_SUCCESS,
              payload:data
            })  
...
export const campaignSingle =(id) => async (dispatch,getState)=>{
    ...
    const {
        ...
        const {data} =await axios.get(`/api/users/campaign/${id}/id/`,
        configuration
        )
    ...
    dispatch({
        ...
        {   
            dispatch({type:CAMPAIGN_GET_FAIL,
            payload:error.response && error.response.data.detail
            ?   error.response.data.detail 
            :   error.message,  
        })
...
export const kickLive =(id) => async (dispatch,getState)=>{

    try{
    dispatch({
        type:KICK_GET_REQUEST
    })

    const {data} =await axios.get(`/api/users/kickstarter/daily/${id}/`)
    console.log("anney:   ",data)
    dispatch({
              type:KICK_GET_SUCCESS,
              payload:data
            })             
        }
        catch(error)
        {   
            dispatch({type:KICK_GET_FAIL,
            payload:error.response && error.response.data.detail
            ?   error.response.data.detail 
            :   error.message,  
        })
